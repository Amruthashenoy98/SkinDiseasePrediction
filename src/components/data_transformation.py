...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            train_df=train_df.drop(['polygonal_papules', 'oral_mucosal_involvement', 'melanin_incontinence','clubbing_of_the_rete_ridges',
            ...
            test_df=test_df.drop(['polygonal_papules', 'oral_mucosal_involvement', 'melanin_incontinence','clubbing_of_the_rete_ridges',
              'thinning_of_the_suprapapillary_epidermis', 'focal_hypergranulosis','vacuolisation_and_damage_of_basal_layer',
              'saw-tooth_appearance_of_retes', 'follicular_horn_plug','perifollicular_parakeratosis', 'band-like_infiltrate'],axis=1)
